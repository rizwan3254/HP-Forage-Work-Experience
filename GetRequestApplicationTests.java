...
class GetRequestApplicationTests {
	...
	int getEmployeeCount(EmployeeManager m)
	{
		return m.getAllEmployees().getEmployeeList().size();
	}
	...
	void createEmployeeManager() {
		...
		assert(getEmployeeCount(newManager) != 0);
	}
	...
	void addEmployee() {
		...
		Employee employee = new Employee("rtariq23", "Rizwan", "Tariq", "tariqrizwan41@gmail.com", "Teacher");
		manager.addEmployee(employee);
		assert(employeeCount + 1 == getEmployeeCount(manager));
	}
    ...
    @BeforeEach void setUp()
    {
		...
		Employee newEmployee = new Employee("rtariq23", "Rizwan", "Tariq", "tariqrizwan41@gmail.com", "Teacher");
